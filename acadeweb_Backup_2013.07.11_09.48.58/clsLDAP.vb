Module clsLDAP
    ...
    Function StaffCheckAccount(ByVal strAccount As String, ByVal strPWD As String) As Boolean
        Try
            Dim LdapServer As String = "LDAP://ldap.niu.edu.tw/dc=ldap,dc=niu,dc=edu,dc=tw" 'IP Address 
            'Dim strTmp0 As String = LdapServer


            Dim LdapEntry As DirectoryServices.DirectoryEntry = New DirectoryServices.DirectoryEntry(LdapServer, strAccount, strPWD, DirectoryServices.AuthenticationTypes.None)

            Dim LdapSearcher As DirectoryServices.DirectorySearcher = New DirectoryServices.DirectorySearcher(LdapEntry, "(ou=teacher)")
