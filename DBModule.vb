...
Module DBModule
    ...
    Public DBconString As String = "Provider=SQLOLEDB;Data Source=120.101.1.61;Persist Security Info=True;Password=vu4wj/3yj3;User ID=syscc;Initial Catalog=IltAcade0201"
