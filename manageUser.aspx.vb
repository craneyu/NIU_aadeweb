...
Public Class manageUser
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack And DDL_Unit.SelectedValue <> "NULL" Then
            SqlDataSource1.SelectCommand = "SELECT [email] as code, [Name] FROM [UserDB] WHERE [unit] = " & DDL_Unit.SelectedValue
        Else
            SqlDataSource1.SelectCommand = "SELECT [email] as code, [Name] FROM [UserDB] "
        End If
    End Sub
    ...
    Private Sub RG_List_ItemCommand(sender As Object, e As Telerik.Web.UI.GridCommandEventArgs) Handles RG_List.ItemCommand
        ...
        If e.CommandName = "Select" Then
            ...
            SQL = "select Name,RightSingle from UserDB where email = '" & Code & "'"
