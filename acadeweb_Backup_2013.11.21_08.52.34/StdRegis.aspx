              ...
              <h2><img src="image/icon_agenda_info.gif" alt="" />學生註冊管理</h2>
               <table border="0" cellpadding="3" cellspacing="1">
                 <tr>
                  ...
                  <td> 
                    ...
                    ControlObjectsVisibility="None" Skin="Windows7" Height="21px" Width="226px" 
                          ClientIDMode="Inherit" AllowedFileExtensions=".xls,.xlsx">
                 ...
                 <tr>
                   <td>&nbsp;</td>
                  <td> 
                      <span style="color:Red; font-size:15px">*學生證欄位務必設定為 <b>RegsNo</b><br />
                      *可用Excel 2007以上版本</span></td>
                  <td>
                      <asp:Button ID="Import_StdData" runat="server" Text="匯入資料庫" Enabled="False" />
                     </td>
                     <td>
                         &nbsp;</td>
                 </tr>
