            ...
            <div>
                <telerik:RadTabStrip ID="RadTabStrip1" runat="server" 
                    ...
                    <Tabs>
                        ...
                        <telerik:RadTab runat="server" Text="批次作業" Owner="RadTabStrip1" Selected="True">
                        </telerik:RadTab>
                    </Tabs>
                </telerik:RadTabStrip>
                <telerik:RadMultiPage ID="RadMultiPage1" Runat="server" SelectedIndex="1">
                           ...
                           <p>　請輸入學生證號：<asp:TextBox ID="Txt_StdNo" runat="server"></asp:TextBox>
                            ...
                            　<asp:Panel ID="Panel1" runat="server">
                                ...
                                　        RFID外碼：<asp:TextBox ID="Txt_RFID_outcode" runat="server"></asp:TextBox>
                                    ...
                                    <tr>
                                      <td colspan="2">上次更新時間：<asp:Label ID="Lab_LastUpdate" runat="server" Text="Label"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                    ...
                    <telerik:RadPageView ID="RadPageView2" runat="server">
                        <table cellpadding="5">
                           <tr>
                              ...
                              <td>
                                <telerik:RadUpload ID="RadUpload1" Runat="server" ControlObjectsVisibility="None" 
                                      Skin="Windows7" Height="21px" Width="226px" Filter="Excel檔案(*.xls;*.xlsx)|*.xls;*.xlsx"
                                    AllowedFileExtensions=".xls,.xlsx" ClientIDMode="Inherit">
                           ...
                           <tr>
                              <td colspan="3">備註：<br /> 　欄位名稱：1.學生證號 RegsNo&nbsp;&nbsp; 2.RFID內碼：incode&nbsp;&nbsp; 3.RFID外碼：outcode<br /> 
                                  　可用Excel 2007以上版本(*.xlsx)</td>
                           </tr>
                        </table>
