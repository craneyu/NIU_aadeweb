...
Public Class StdRegis
    ...
    Sub RD_Data(ByVal T As Integer)
        ...
        If T = 0 Then  '預設初始,依承辦單位,全部呈現
            ...
            SQL += "stdid.IDNO as IDNO, case niu_dbase.dbo.FeeState.FeeStatus when '1' then '已繳費' when '2' then '已辦理貸款' end as FeeStatus FROM niu_dbase.dbo.FeeState INNER JOIN stdid ON "
            SQL += "niu_dbase.dbo.FeeState.RegsNo = stdid.REGSNO INNER JOIN DEPT ON stdid.Class =DEPT.class "
