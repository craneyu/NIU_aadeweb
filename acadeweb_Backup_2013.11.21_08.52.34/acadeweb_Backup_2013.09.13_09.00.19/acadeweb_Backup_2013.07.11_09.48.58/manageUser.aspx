...
<body>
        ...
        <uc1:Registry_menu ID="Registry_menu1" runat="server" />
         <div class="spacer"></div>
          ...
          <p>依單位搜尋：<asp:DropDownList ID="DDL_Unit" runat="server" AutoPostBack="True">
              ...
              <telerik:RadGrid ID="RG_List" runat="server" CellSpacing="0" Culture="zh-TW" 
  ...
  <telerik:GridTemplateColumn FilterControlAltText="Filter TemplateColumn column" 
        ...
        <telerik:GridBoundColumn DataField="pw" FilterControlAltText="Filter pw column" 
            HeaderText="密碼" SortExpression="pw" UniqueName="pw" Visible="false">
        </telerik:GridBoundColumn>
        <telerik:GridTemplateColumn>
            <ItemTemplate>
                <asp:Button ID="click" runat="server" Text="Select" CommandName="select" CssClass="input05" />
            </ItemTemplate>
...
<FilterMenu EnableImageSprites="False"></FilterMenu>
          ...
          <div class="content_right">
              <img alt="" class="style2" src="image/ico_02.jpg" /> 權限設定<br />
              <br />
              <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>
              <telerik:RadTreeView ID="RadTreeView1" Runat="server" CheckChildNodes="True" 
                  DataFieldID="ID" DataFieldParentID="ParentID" DataSourceID="SqlDataSource2" 
                  DataTextField="Menu_Name" Skin="Silk">
              </telerik:RadTreeView>
