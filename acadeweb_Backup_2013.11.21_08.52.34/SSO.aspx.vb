...
Public Class SSO
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Dim SQL, SQL2, SQL3, GUID, Account, Acade_DB As String
        Dim da As SqlDataAdapter
        Dim dt, dt_YS, dt_dept As New DataTable
        Dim CheckAccount As New ServiceReference2.SSOGUIDSoapClient
        ...
        If GUID <> "" Then
            ...
            'Exit Sub
            Account = CheckAccount.GetUId(GUID)
