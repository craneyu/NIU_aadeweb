<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="StdRegisView.aspx.vb"
    Inherits="acadeweb.StdRegisView" %>
...
<body>
    ...
    <div>
        ...
        <div class="textMain2">
            ...
            <p>
                依學號查詢：<asp:TextBox ID="Txt_StdNo" runat="server" Columns="10"></asp:TextBox>
                <asp:Button ID="But_SearchByStdNo" runat="server" Text="查詢" />
            &nbsp;
                <asp:Button ID="But_Export" runat="server" Text="匯出Excel檔" />
            </p>
...
<FilterMenu EnableImageSprites="False"></FilterMenu>
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="DDL_College">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RGD_View" UpdatePanelCssClass="" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="DDL_Dept">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RGD_View" UpdatePanelCssClass="" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="DDL_Grade">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RGD_View" UpdatePanelCssClass="" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="DDL_Class">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RGD_View" UpdatePanelCssClass="" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="DDL_FeeStatus">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RGD_View" UpdatePanelCssClass="" />
                    <telerik:AjaxUpdatedControl ControlID="Label1" UpdatePanelCssClass="" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="But_SearchByStdNo">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RGD_View" UpdatePanelCssClass="" />
                </UpdatedControls>
            </telerik:AjaxSetting>
